...
function localToCloud(co: ChangeOrder, userId: string) {
  return {
    id: co.id,
    user_id: userId,
    contract_id: co.contractId || null,
    quote_id: co.quoteId || null,
    quote_number: co.quoteNumber || null,
    number: co.number,
    parent_change_order_id: co.parentChangeOrderId || null,
    display_number: co.displayNumber || null,
    description: co.description || null,
    completed_at: co.completedAt || null,
    items: co.items,
    ...
    for (const localRow of localCORows) {
      try {
        ...
        const localCO: ChangeOrder = {
          id: localRow.id,
          contractId: localRow.contractId,
          quoteId: localRow.quoteId,
          quoteNumber: localRow.quoteNumber,
          number: localRow.number,
          parentChangeOrderId: localRow.parentChangeOrderId,
          displayNumber: localRow.displayNumber,
