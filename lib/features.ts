...
/**
 * Check if user can access pricebook (all users - free tier limited to 50 items)
 */
export function canAccessPricebook(_user: UserState): boolean {
  return true; // All users have pricebook access now
}
