...
const CONSTRUCTION_SYNONYMS: Array<{ term: string; canonical: string }> = [
  // Dimensional lumber - all common sizes
  ...
  { term: "4x6", canonical: "4 in x 6 in" },
  { term: "6x6", canonical: "6 in x 6 in" },
  { term: "1x4", canonical: "1 in x 4 in" },
  { term: "1x6", canonical: "1 in x 6 in" },
  { term: "1x8", canonical: "1 in x 8 in" },
  { term: "1x10", canonical: "1 in x 10 in" },
  { term: "1x12", canonical: "1 in x 12 in" },
  // Deck boards
  { term: "5/4", canonical: "five quarter" },
  { term: "5/4x6", canonical: "five quarter" },
  // Common abbreviations
  { term: "pt", canonical: "pressure treated" },
  { term: "gc", canonical: "ground contact" },
  { term: "kd", canonical: "kiln dried" },
  ...
  { term: "cdx", canonical: "plywood sheathing" },
  // Electrical
  { term: "gfci", canonical: "ground fault circuit interrupter" },
  { term: "gfi", canonical: "ground fault circuit interrupter" },
  { term: "afci", canonical: "arc fault circuit interrupter" },
  { term: "romex", canonical: "nm-b wire" },
  { term: "nm", canonical: "nm-b" },
  { term: "thhn", canonical: "thhn thwn wire" },
  { term: "emt", canonical: "electrical metallic tubing conduit" },
  { term: "12/2", canonical: "12 2 wire" },
  { term: "14/2", canonical: "14 2 wire" },
  { term: "10/3", canonical: "10 3 wire" },
  // Plumbing
  { term: "pex", canonical: "pex tubing" },
  { term: "cpvc", canonical: "cpvc pipe" },
  { term: "abs", canonical: "abs pipe" },
  { term: "sharkbite", canonical: "push fit fitting" },
  // Drywall
  { term: "sheetrock", canonical: "drywall" },
  { term: "gypsum", canonical: "drywall" },
  { term: "gyp", canonical: "drywall" },
  { term: "mud", canonical: "joint compound" },
  // Fasteners
  { term: "drywall screws", canonical: "drywall screw" },
  { term: "deck screws", canonical: "deck screw" },
  { term: "tapcon", canonical: "concrete anchor screw" },
  { term: "#8", canonical: "number 8" },
  { term: "#10", canonical: "number 10" },
  { term: "#6", canonical: "number 6" },
  // Concrete
  { term: "rebar", canonical: "reinforcing bar" },
  { term: "quickcrete", canonical: "concrete mix" },
  { term: "quikrete", canonical: "concrete mix" },
  { term: "sakrete", canonical: "concrete mix" },
  // Insulation
  { term: "r13", canonical: "r-13 insulation" },
  { term: "r19", canonical: "r-19 insulation" },
  { term: "r30", canonical: "r-30 insulation" },
  { term: "r38", canonical: "r-38 insulation" },
  // Hardware
  { term: "simpson", canonical: "simpson strong-tie" },
  { term: "lus", canonical: "joist hanger" },
  // Roofing
  { term: "30yr", canonical: "30 year shingle" },
  { term: "architectural", canonical: "architectural shingle" },
  // Paint
  { term: "kilz", canonical: "primer" },
  { term: "drylok", canonical: "waterproof sealer" },
];
...
// More specific keywords listed first to ensure proper matching
const CANONICAL_CATEGORIES: Record<string, string[]> = {
  "Framing Lumber": ["framing lumber", "dimensional lumber", "studs", "2x4", "2x6", "2x8", "2x10", "2x12", "stud"],
  "Treated Lumber": ["pressure treated", "ground contact", "treated lumber", "exterior lumber", "pt lumber"],
  "Sheet Goods": ["plywood", "osb", "sheathing", "mdf", "particleboard", "cdx", "oriented strand"],
  "Trim & Boards": ["trim", "molding", "baseboard", "casing", "1x4", "1x6", "1x8", "board"],
  "Electrical": ["electrical", "wire", "wiring", "outlet", "switch", "breaker", "panel", "conduit", "romex", "circuit", "receptacle"],
  "Plumbing": ["plumbing", "pipe", "fitting", "faucet", "toilet", "valve", "drain", "pvc", "copper", "pex", "cpvc"],
  "Drywall": ["drywall", "sheetrock", "gypsum", "joint compound", "wallboard"],
  "Fasteners": ["fastener", "screw", "nail", "bolt", "anchor", "bracket"],
  "Hardware": ["hardware", "hinge", "handle", "knob", "lock", "latch"],
  "Paint & Stain": ["paint", "primer", "stain", "coating", "sealer", "caulk"],
  "Flooring": ["flooring", "tile", "laminate", "vinyl floor", "hardwood floor", "carpet", "underlayment", "lvp"],
  "Roofing": ["roofing", "shingle", "flashing", "gutter", "soffit", "fascia", "roof"],
  "Insulation": ["insulation", "foam board", "fiberglass", "weatherstrip", "r-13", "r-19", "r-30"],
  ...
  "Decking": ["deck", "decking", "railing", "composite", "pergola", "five quarter", "5/4"],
  "Fencing": ["fence", "fencing", "gate", "picket", "post"],
  "Concrete & Masonry": ["concrete", "cement", "mortar", "brick", "block", "paver", "rebar", "quikrete"],
