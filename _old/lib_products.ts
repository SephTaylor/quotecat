...
export const PRODUCTS_SEED: Product[] = [
  ...
  {
    id: "screw_drywall_1_1_4_box",
    name: 'Drywall Screws 1-1/4" (1 lb)',
    category: "Fasteners",
    unit: "box",
    unitPrice: 6.5,
  },
  {
    id: "mud_all_purpose_5gal",
  ...
  {
    id: "tape_drywall_250ft",
    name: "Drywall Tape 250 ft",
    category: "Drywall",
    unit: "roll",
    unitPrice: 3.7,
  },
  {
    id: "paint_int_eggshell_gal",
    name: "Interior Paint Eggshell (gal)",
    category: "Paint",
    unit: "gal",
    unitPrice: 24.0,
  },
  {
    id: "wire_nm_b_12_2_250ft",
  ...
  {
    id: "switch_singlepole_decora",
    name: "Switch Single-Pole (Decora)",
    category: "Electrical",
    unit: "ea",
    unitPrice: 3.2,
  },
...
export const CATEGORIES = Array.from(
  new Set(PRODUCTS_SEED.map((p) => p.category)),
).sort();
